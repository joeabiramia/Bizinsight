...
export default function ExcelOnlinePage() {
  return (
    <MainLayout>
      <PageHeader
        eyebrow="Live Data"
        title="Excel Online / OneDrive"
        description="Connect your Excel files from OneDrive for live data synchronization."
      />
      <ComingSoonBanner feature="Excel Online Connector" />
    </MainLayout>
  );
}
